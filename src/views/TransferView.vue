<template>
  <div class="container mx-auto max-w-5xl py-1 md:py-2">
    ...
    <div class="mb-10 rounded-xl bg-white p-6 shadow-md border border-gray-100">
      ...
      >
        ...
        <div class="space-y-1">
          ...
          <ThaiTimePicker v-model="formData.time" />
        </div>
        ...
        >
          ...
          <form @submit.prevent="submitEdit" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-1">
                <label class="block text-sm font-semibold text-gray-700">วันที่</label>
                <ThaiDatePicker v-model="editData.date" />
              </div>
              <div class="space-y-1">
                <label class="block text-sm font-semibold text-gray-700">เวลา</label>
                <ThaiTimePicker v-model="editData.time" />
              </div>
            </div>
